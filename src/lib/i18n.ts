...
export const STRINGS = {
  ru: {
    ...
    suggestUezdAction: "Предложить корректировку уезда",
    suggestUezdTitle: "Предложить корректировку уезда",
    suggestUezdHint: "Предложите более точную атрибуцию уезда. Запись попадёт в очередь модерации в админке.",
    suggestUezdCurrent: "Текущий уезд",
    suggestUezdProposed: "Предлагаемый уезд",
    suggestUezdNote: "Комментарий (необязательно)",
    suggestUezdSubmit: "Отправить",
    suggestUezdCancel: "Отмена",
    suggestUezdSubmitted: "Предложение сохранено",
    suggestUezdEmpty: "Заполните хотя бы одно языковое поле",
  },
  en: {
