...
export const STRINGS = {
  ...
  en: {
    ...
    suggestUezdAction: "Suggest uezd correction",
    suggestUezdTitle: "Suggest uezd correction",
    suggestUezdHint: "Propose a more accurate uezd attribution. The entry will go to the admin moderation queue.",
    suggestUezdCurrent: "Current uezd",
    suggestUezdProposed: "Proposed uezd",
    suggestUezdNote: "Comment (optional)",
    suggestUezdSubmit: "Submit",
    suggestUezdCancel: "Cancel",
    suggestUezdSubmitted: "Suggestion saved",
    suggestUezdEmpty: "Fill at least one language field",
  },
  ka: {
