...
export const TBILISI_STRINGS = {
  ru: {
    ...
    metaDesc:
      "Интерактивная карта 108 церквей Тбилиси (Тифлиса) разных конфессий — годы метрических книг, ссылки на записи в Национальном историческом архиве Грузии, просмотр точек на старых картах Тифлиса 1898 и 1904 годов.",
    h1: "Церкви Тбилиси",
    subtitle: "108 приходов разных конфессий · метрические книги 1818–1924 · старые карты 1898 и 1904 гг.",
  ...
  en: {
    ...
    metaDesc:
      "Interactive map of 108 churches of Tbilisi (Tiflis) across confessions — parish-register years, links to records in the National Historical Archive of Georgia, church points overlaid on the old Tiflis maps of 1898 and 1904.",
    h1: "Churches of Tbilisi",
    subtitle: "108 parishes across confessions · parish registers 1818–1924 · old maps of 1898 and 1904",
  ...
  ka: {
    ...
    metaDesc:
      "თბილისის 108 ეკლესიის ინტერაქტიული რუკა სხვადასხვა კონფესიის მიხედვით — მეტრიკული წიგნების წლები, საქართველოს ეროვნული ისტორიული არქივის ჩანაწერების ბმულები, წერტილების ნახვა თბილისის 1898 და 1904 წლების ძველ რუკებზე.",
    h1: "თბილისის ეკლესიები",
    subtitle: "108 სამრევლო სხვადასხვა კონფესიის · მეტრიკული წიგნები 1818–1924 · ძველი რუკები 1898 და 1904 წწ.",
