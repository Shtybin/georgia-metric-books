...
export const TBILISI_STRINGS = {
  ...
  en: {
    ...
    confessionsShort: {
      orthodox_georgian: "Georgians",
      orthodox_russian: "Russians",
      orthodox_military: "Military",
      armenian_apostolic: "Armenians",
      greek_orthodox: "Greeks",
      roman_catholic: "Catholics",
      lutheran: "Lutherans",
      jewish: "Jews",
      molokan: "Molokans",
      baptist: "Baptists",
  ...
  ka: {
    ...
    confessionsShort: {
      orthodox_georgian: "ქართველები",
      orthodox_russian: "რუსები",
      orthodox_military: "სამხედრო",
      armenian_apostolic: "სომხები",
      greek_orthodox: "ბერძნები",
      roman_catholic: "კათოლიკები",
      lutheran: "ლუთერანები",
      jewish: "იუდევლები",
      molokan: "მოლოკანები",
      baptist: "ბაპტისტები",
