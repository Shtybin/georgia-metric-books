...
const ADMIN_ALIASES: { hist: string[]; modern: string[] }[] = [
  ...
  // Тифлисский уезд / район ↔ Тбилиси / Квемо-Картли / Мцхета-Мтианети
  { hist: ["тифлис", "тбилис", "tiflis", "tbilis", "ტფილის", "თბილის"], modern: ["тбилис", "tbilis", "თბილის", "мцхет", "mtskheta", "квемо", "kvemo", "картли", "kartli"] },
  // Гурийский уезд ↔ Гурия (регион) / Озургети / Ланчхути / Чохатаури
  { hist: ["гури", "guri", "გური"], modern: ["гури", "guri", "გური", "озургет", "ozurget", "ланчхут", "lanchkhut", "чохатаур", "chokhatauri"] },
];
