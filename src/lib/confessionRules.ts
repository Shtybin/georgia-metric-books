...
// Иудейские общины — добавляем категорию только в исторически подтверждённых
// центрах грузинского еврейства, где велись отдельные метрические книги
// синагоги (по описи фонда 489 Национального исторического архива Грузии).
// Список умышленно консервативен: только города/посады с действующей
// синагогой в XIX — начале XX в.
const JEWISH_TOWNS = new Set([
  "ахалцихе", "они", "кулаши", "лайлаши",
  "цхинвал", "цхинвали", "кутаиси", "сурами",
]);
