...
// Иудейские общины: НЕ добавляем категорию по ареальной подсказке.
// Категория `jewish` присваивается ТОЛЬКО когда в поле `church` (RU/EN/KA)
// явно упомянута синагога/еврейская/иудейская община — см. KEYWORD_RULES.
// Это предотвращает ложные срабатывания на православных храмах в городах,
// где исторически также была синагога (Ахалцихе, Кутаиси, Они и др.).
...
//   • Цхинвали, Душет, Ананури, Мцхета — этапные гарнизоны;
