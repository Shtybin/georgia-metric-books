...
export const HISTORICAL_MAPS: HistoricalMapEntry[] = [
  ...
  {
    id: "1904",
    title: "Тифлис, 1904 (Городская управа)",
    year: 1904,
    config: TBILISI_1904,
    notes:
      "План с проектируемыми избирательными участками. Границы полицейских участков отрисованы на скане; GeoJSON оцифруем отдельно.",
  },
  {
    id: "1735-vakhushti",
