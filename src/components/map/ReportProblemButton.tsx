  ...
  return (
    <>
      <button
        ...
        className="pointer-events-auto absolute bottom-3 left-3 z-20 inline-flex items-center gap-1.5 rounded-full border border-border bg-card/90 px-2.5 py-1 text-[11px] font-medium text-muted-foreground shadow-md backdrop-blur hover:bg-accent hover:text-foreground"
      ...
      {sentToast && (
        <div className="pointer-events-none absolute bottom-12 left-3 z-30 rounded-md border border-border bg-card/98 px-3 py-1.5 text-xs shadow-2xl backdrop-blur">
          {sentToast}
        </div>
      )}
    </>
