...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Интерактивная карта приходских метрических книг Грузии 1819–1930 года: поиск, периоды, анализ в радиусе 10 км." },
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
          ...
          приходов в радиусе 10 км, мультиязычный поиск.
        </p>
        ...
        <div className="mt-4 grid gap-6 sm:grid-cols-3">
          {[
            { i: MapPin, t: "Анализ радиуса 10 км", d: "Кликните точку — увидите все приходы поблизости." },
